...
export default function About() {
  return (
    <section id="about" className="min-h-screen flex items-center px-8 md:px-20 py-20">
      <div className="max-w-6xl w-full mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          <div className="w-64 h-64 rounded-2xl border-2 border-[#7c3aed] flex items-center justify-center text-gray-600 font-mono text-sm">
            your photo here
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <p className="text-[#7c3aed] font-mono text-sm mb-3 tracking-widest">&gt; about_me.txt</p>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={item.label} className="border border-gray-800 rounded-lg p-4">
                <p className="text-[#7c3aed] font-mono text-xs mb-1">{item.label}</p>
